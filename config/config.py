...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "ᴀɴᴜ")

OWNER_ID = list(map(int, getenv("OWNER_ID", "5233742848").split()))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/anu_pui")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/anu_0_0_0")
